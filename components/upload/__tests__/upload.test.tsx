...
describe('Upload', () => {
  ...
  it('should support events', () => {
    ...
    fireEvent.click(wrapper.querySelector('.ant-upload-trigger')!);
    expect(onClick).toHaveBeenCalled();
    fireEvent.mouseEnter(wrapper.querySelector('.ant-upload-trigger')!);
    expect(onMouseEnter).toHaveBeenCalled();
    fireEvent.mouseLeave(wrapper.querySelector('.ant-upload-trigger')!);
